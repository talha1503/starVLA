...
- [Qwen3VL-GR00T-Bridge-RT-1](https://huggingface.co/placeholder/Qwen3VL-GR00T-Bridge-RT-1) — 65.3 avg success
- [Qwen3VL-PI_v3-Bridge-RT-1](https://huggingface.co/placeholder/Qwen3VL-PI_v3-Bridge-RT_1) — **69.8 avg success** (layer-wise cross-DiT flow-matching head, π₀.₅-style)
