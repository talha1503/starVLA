...
def build_trainer_command(cfg: Any, setup: dict[str, Any], workspace_dir: Path, run_root_dir: str) -> list[str]:
    cmd = [
        ...
        f"wandb_entity={_cfg_get(cfg, 'wandb_entity')}",
        f"wandb_project={_cfg_get(cfg, 'wandb_project')}",
    ...
    for cfg_path, hydra_path in (
        ...
        ("trainer.eval_action_classification", "trainer.eval_action_classification"),
        ("trainer.eval_action_classification_interval", "trainer.eval_action_classification_interval"),
        ...
        ("trainer.freeze_vit", "trainer.freeze_vit"),
        ("trainer.freeze_llm_layers", "trainer.freeze_llm_layers"),
        ...
        ("trainer.profile_timing.enabled", "trainer.profile_timing.enabled"),
        ("trainer.profile_timing.log_interval", "trainer.profile_timing.log_interval"),
        ...
        ("datasets.vla_data.num_workers", "datasets.vla_data.num_workers"),
        ("datasets.vla_data.eval_num_workers", "datasets.vla_data.eval_num_workers"),
        ("datasets.vla_data.prefetch_factor", "datasets.vla_data.prefetch_factor"),
        ("datasets.vla_data.persistent_workers", "datasets.vla_data.persistent_workers"),
        ("datasets.vla_data.pin_memory", "datasets.vla_data.pin_memory"),
