...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="placeholder/pi05_bridge_deadly_corridor_rtx3090_profile_1000ep_7k2steps_final" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/pi05_bridge_deadly_corridor_rtx3090_profile_1000ep_7k2steps_final" \
