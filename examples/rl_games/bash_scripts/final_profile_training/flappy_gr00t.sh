...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="placeholder/gr00t_bridge_flappy_rtx3090_profile_1000ep_7k2steps_final_action_1e-4_backbone_1e-5" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/gr00t_bridge_flappy_rtx3090_profile_1000ep_7k2steps_final_action_1e-4_backbone_1e-5" \
