...
python examples/rl_games/scripts/launch_train.py \
    ...
    init=bridge \
    mode=mixed_latency \
    run_id="gr00t_bridge_flappy_rtx3090_profile_1000ep_7k2steps_final_action_1e-4_backbone_1e-5" \
    ...
    checkpoint.hf_repo_id="latency-sensitive-bench/gr00t_bridge_flappy_rtx3090_profile_1000ep_7k2steps_final_action_1e-4_backbone_1e-5" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="latency-sensitive-bench/gr00t_bridge_flappy_rtx3090_profile_1000ep_7k2steps_final_action_1e-4_backbone_1e-5" \
    dataset.source_hf=latency-sensitive-bench/memory-rollouts \
    dataset.source_subdir=flappy_gr00t_rtx3090_profile_1000ep_7200steps \
