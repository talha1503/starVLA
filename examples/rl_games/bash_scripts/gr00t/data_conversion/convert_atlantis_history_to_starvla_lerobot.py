...
from examples.rl_games.bash_scripts.gr00t.data_conversion import (
    ...
    convert_atlantis_to_starvla_lerobot as atlantis_converter,
)
...
def convert_hub_dataset(
    ...
    return history_converter.convert_hub_dataset(
        ...
        dataset_config_name,
        output_dir,
        source_env_name="atlantis",
        display_name="Atlantis",
        base_converter=atlantis_converter.base,
        cache_dir=cache_dir,
        ...
        conversion_context=atlantis_converter._atlantis_constants,
    )


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Convert row-history Atlantis rollouts into WanOFT context-image LeRobot format."
    )
    ...
    parser.add_argument(
        ...
        default=atlantis_converter.base.DEFAULT_CONTEXT_IMAGES_OUTPUT_COLUMN,
    )
