...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="placeholder/gr00t_bridge_flappy_single_latency_clean_data_exp2_action_5e-5_backbone_5e-6" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/gr00t_bridge_flappy_single_latency_clean_data_exp2_action_5e-5_backbone_5e-6" \
