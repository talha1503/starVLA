...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="talha15032/openvla_bridge_cross_demon_mixed_flappy_zero_exp4" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="talha15032/openvla_bridge_cross_demon_mixed_flappy_zero_exp4" \
    ...
    rl_games.cross_task.train_tasks.1.prompt_source_hf=talha1503/flappy_bird_mixed_latency_parquet \
