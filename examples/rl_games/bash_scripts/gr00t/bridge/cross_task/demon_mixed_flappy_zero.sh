...
bash examples/rl_games/install/install_stack.sh gr00t cross_task
...
python examples/rl_games/scripts/launch_train.py \
    ...
    run_id="gr00t_bridge_cross_demon_mixed_flappy_zero_exp4" \
    ...
    checkpoint.hf_repo_id="placeholder/gr00t_bridge_cross_demon_mixed_flappy_zero_exp4" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/gr00t_bridge_cross_demon_mixed_flappy_zero_exp4" \
    ...
    rl_games.cross_task.train_tasks.0.train_source_hf=placeholder/demon_attack_mixed_latency_min_0_max_7 \
    rl_games.cross_task.train_tasks.0.prompt_source_hf=placeholder/demon_attack_mixed_latency_min_0_max_7 \
    ...
    rl_games.cross_task.train_tasks.1.train_source_hf=placeholder/flappy_bird_zero_latency_parquet \
    rl_games.cross_task.train_tasks.1.prompt_source_hf=placeholder/flappy_bird_mixed_latency_parquet \
