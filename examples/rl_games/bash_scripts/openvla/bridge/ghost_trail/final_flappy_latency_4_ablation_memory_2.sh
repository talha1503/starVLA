...
python examples/rl_games/scripts/launch_train.py \
    ...
    init=bridge \
    mode=single \
    run_id="openvla_bridge_flappy_fixed_latency_3_200ep_7k2steps_ghost7_exp3" \
    ...
    checkpoint.hf_repo_id="placeholder/openvla_bridge_flappy_fixed_latency_3_200ep_7k2steps_ghost7_exp3" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_bridge_flappy_fixed_latency_3_200ep_7k2steps_ghost7_exp3" \
