...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="placeholder/openvla_bridge_demon_attack_latency_6_ghost_trail_memory_exp1_60" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_bridge_demon_attack_latency_6_ghost_trail_memory_exp1_60" \
    dataset.source_hf="placeholder/demon_attack_ghost60_200ep" \
