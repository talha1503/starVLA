...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="talha1503/openvla_bridge_cross_deadly_zero_demon_024_exp1" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="talha1503/openvla_bridge_cross_deadly_zero_demon_024_exp1" \
