...
python examples/rl_games/scripts/launch_train.py \
    ...
    run_id="openvla_bridge_cross_demon_mixed_flappy_zero_exp4" \
    ...
    checkpoint.hf_repo_id="placeholder/openvla_bridge_cross_demon_mixed_flappy_zero_exp4" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_bridge_cross_demon_mixed_flappy_zero_exp4" \
