...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="talha15032/openvla_bridge_cross_demon_024_flappy_zero_clean_data_exp3" \
    checkpoint.sync.enabled=true \
    datasets.vla_data.sequential_step_sampling=true \
    datasets.vla_data.shuffle=true \
    checkpoint.sync.repo_id="talha15032/openvla_bridge_cross_demon_024_flappy_zero_clean_data_exp3" \
