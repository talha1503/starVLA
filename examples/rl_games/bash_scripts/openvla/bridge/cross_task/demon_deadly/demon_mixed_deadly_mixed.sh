...
python examples/rl_games/scripts/launch_train.py \
    ...
    run_id="openvla_bridge_cross_demon_024_deadly_024_exp3" \
    trainer.distributed_backend=none \
    workspace_dir="$WORKSPACE_DIR" \
    wandb_entity="anonymous" \
    checkpoint.hf_repo_id="placeholder/openvla_bridge_cross_demon_024_deadly_024_exp3" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_bridge_cross_demon_024_deadly_024_exp3" \
    checkpoint.save_best_model=false \
    trainer.max_train_steps=2600 \
    datasets.vla_data.sequential_step_sampling=true \
    datasets.vla_data.shuffle=true \
    trainer.num_warmup_steps=0 \
    trainer.eval_interval=400 \
    trainer.save_interval=2600 \
    ...
    rl_games.cross_task.train_tasks.0.converted_name=demon_attack_024_cross_train_openvla_bridge_cross_demon_024_deadly_024_exp3 \
    ...
    rl_games.cross_task.train_tasks.1.converted_name=deadly_corridor_024_cross_train_openvla_bridge_cross_demon_024_deadly_024_exp3 \
