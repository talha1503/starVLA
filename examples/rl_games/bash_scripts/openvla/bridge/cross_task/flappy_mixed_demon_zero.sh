...
python examples/rl_games/scripts/launch_train.py \
    ...
    run_id="openvla_bridge_cross_flappy_024_demon_zero_clean_data_exp2" \
    trainer.distributed_backend=none \
    workspace_dir="/workspace" \
    wandb_entity="talha1503" \
    checkpoint.hf_repo_id="talha15032/openvla_bridge_cross_flappy_024_demon_zero_clean_data_exp2" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="talha15032/openvla_bridge_cross_flappy_024_demon_zero_clean_data_exp2" \
