...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="talha15032/openvla_bridge_cross_defendtheline_zero_deadly_zero_exp3" \
    ...
    rl_games.cross_task.train_tasks.0.train_source_hf=latency-sensitive-bench/memory-rollouts \
    rl_games.cross_task.train_tasks.0.prompt_source_hf=latency-sensitive-bench/memory-rollouts \
