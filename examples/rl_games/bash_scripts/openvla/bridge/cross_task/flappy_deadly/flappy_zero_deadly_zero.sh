...
python examples/rl_games/scripts/launch_train.py \
    ...
    run_id="openvla_bridge_cross_flappy_zero_deadly_zero_exp3 " \
    trainer.distributed_backend=none \
    workspace_dir="$WORKSPACE_DIR" \
    wandb_entity="anonymous" \
    checkpoint.hf_repo_id="placeholder/openvla_bridge_cross_flappy_zero_deadly_zero_exp3" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_bridge_cross_flappy_zero_deadly_zero_exp3" \
    ...
    rl_games.cross_task.train_tasks.0.converted_name=flappy_200ep_cross_0_train_openvla_bridge_cross_flappy_zero_deadly_zero_exp3 \
    ...
    rl_games.cross_task.train_tasks.1.converted_name=deadly_corridor_0_cross_train_openvla_bridge_cross_flappy_zero_deadly_zero_exp3 \
