...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="placeholder/openvla_bridge_cross_flappy_zero_deadly_024_exp3" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_bridge_cross_flappy_zero_deadly_024_exp3" \
    ...
    rl_games.cross_task.train_tasks.0.converted_name=flappy_200ep_cross_0_train_openvla_bridge_cross_flappy_zero_deadly_024_exp3 \
    ...
    rl_games.cross_task.train_tasks.1.converted_name=deadly_corridor_024_cross_train_openvla_bridge_cross_flappy_zero_deadly_024_exp3 \
