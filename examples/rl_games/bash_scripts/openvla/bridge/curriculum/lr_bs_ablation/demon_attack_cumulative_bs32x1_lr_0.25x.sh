...
python examples/rl_games/scripts/launch_train.py \
    ...
    run_id="openvla_demon_attack_mixed_latency_curriculum_cumulative_clean_exp1_bs_32x1_lr_0.25x" \
    trainer.distributed_backend=none \
    workspace_dir="/workspace" \
    wandb_entity="anonymous" \
    checkpoint.hf_repo_id="placeholder/openvla_demon_attack_mixed_latency_curriculum_cumulative_clean_exp1_bs_32x1_lr_0.25x" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_demon_attack_mixed_latency_curriculum_cumulative_clean_exp1_bs_32x1_lr_0.25x" \
