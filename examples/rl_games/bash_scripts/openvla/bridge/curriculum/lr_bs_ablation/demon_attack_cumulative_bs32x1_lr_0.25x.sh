...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="talha15032/openvla_demon_attack_mixed_latency_curriculum_cumulative_clean_exp1_bs_32x1_lr_0.25x" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="talha15032/openvla_demon_attack_mixed_latency_curriculum_cumulative_clean_exp1_bs_32x1_lr_0.25x" \
