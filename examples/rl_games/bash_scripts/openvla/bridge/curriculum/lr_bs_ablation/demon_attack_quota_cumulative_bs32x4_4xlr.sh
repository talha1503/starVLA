...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="placeholder/openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x4_4xlr" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x4_4xlr" \
