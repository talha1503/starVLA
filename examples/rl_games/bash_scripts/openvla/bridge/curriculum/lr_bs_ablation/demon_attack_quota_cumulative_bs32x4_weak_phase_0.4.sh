...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="talha15032/openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x4_weak_phase_0.4" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="talha15032/openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x4_weak_phase_0.4" \
