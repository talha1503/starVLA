...
python examples/rl_games/scripts/launch_train.py \
    ...
    run_id="openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x4_weak_phase_0.4" \
    trainer.distributed_backend=none \
    workspace_dir="/workspace" \
    wandb_entity="anonymous" \
    checkpoint.hf_repo_id="placeholder/openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x4_weak_phase_0.4" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x4_weak_phase_0.4" \
    ...
    datasets.vla_data.latency_curriculum.new_latency_passes=0.4 \
    datasets.vla_data.latency_curriculum.replay_passes=0.2 \
    datasets.vla_data.latency_curriculum.target_total_passes=1.2 \
