...
python examples/rl_games/scripts/launch_train.py \
    ...
    run_id="openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x4" \
    trainer.distributed_backend=none \
    workspace_dir="/workspace" \
    wandb_entity="anonymous" \
    checkpoint.hf_repo_id="placeholder/openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x4" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x4" \
