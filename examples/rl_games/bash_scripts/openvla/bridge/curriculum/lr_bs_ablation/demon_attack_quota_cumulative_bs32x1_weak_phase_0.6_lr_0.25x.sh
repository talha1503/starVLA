...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="placeholder/openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x1_weak_phase_0.6_lr_0.25x" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_demon_attack_mixed_latency_quota_cumulative_clean_exp1_bs32x1_weak_phase_0.6_lr_0.25x" \
    ...
    datasets.vla_data.latency_curriculum.new_latency_passes=0.6 \
    datasets.vla_data.latency_curriculum.replay_passes=0.15 \
