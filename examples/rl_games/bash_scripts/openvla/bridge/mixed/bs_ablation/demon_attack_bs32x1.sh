...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="talha15032/openvla_demon_attack_mixed_latency_clean_exp2_bs32x1" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="talha15032/openvla_demon_attack_mixed_latency_clean_exp2_bs32x1" \
