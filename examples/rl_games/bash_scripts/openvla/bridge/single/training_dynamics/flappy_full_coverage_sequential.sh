...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="placeholder/openvla_bridge_flappy_single_latency_exp1_30ep_full_coverage_sequential" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_bridge_flappy_single_latency_exp1_30ep_full_coverage_sequential" \
