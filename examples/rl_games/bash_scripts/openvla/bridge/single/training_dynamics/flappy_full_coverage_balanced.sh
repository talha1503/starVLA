...
python examples/rl_games/scripts/launch_train.py \
    ...
    checkpoint.hf_repo_id="talha15032/openvla_bridge_flappy_single_latency_exp1_30ep_full_coverage_balanced_0.3_flap" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="talha15032/openvla_bridge_flappy_single_latency_exp1_30ep_full_coverage_balanced_0.3_flap" \
