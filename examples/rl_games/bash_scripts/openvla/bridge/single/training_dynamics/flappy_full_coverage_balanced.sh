...
python examples/rl_games/scripts/launch_train.py \
    ...
    init=bridge \
    mode=single \
    run_id="openvla_bridge_flappy_single_latency_exp1_30ep_full_coverage_balanced_0.3_flap" \
    trainer.distributed_backend=none \
    workspace_dir="/workspace" \
    wandb_entity="anonymous" \
    checkpoint.hf_repo_id="placeholder/openvla_bridge_flappy_single_latency_exp1_30ep_full_coverage_balanced_0.3_flap" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="placeholder/openvla_bridge_flappy_single_latency_exp1_30ep_full_coverage_balanced_0.3_flap" \
    ...
    datasets.vla_data.action_balance.enabled=true \
    datasets.vla_data.action_balance.target_flap_fraction=0.30 \
