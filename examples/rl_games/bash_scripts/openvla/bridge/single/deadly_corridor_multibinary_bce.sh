...
python examples/rl_games/scripts/launch_train.py \
    ...
    init=bridge \
    mode=single \
    run_id="openvla_bridge_deadly_corridor_single_latency_exp2_multibinary_bce" \
    trainer.distributed_backend=none \
    workspace_dir="/workspace" \
    wandb_entity="talha1503" \
    checkpoint.hf_repo_id="talha1503/openvla_bridge_deadly_corridor_single_latency_exp2_multibinary_bce" \
    checkpoint.sync.enabled=true \
    checkpoint.sync.repo_id="talha1503/openvla_bridge_deadly_corridor_single_latency_exp2_multibinary_bce" \
