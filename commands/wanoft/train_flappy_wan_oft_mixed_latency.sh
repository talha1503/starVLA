...
# Usage:
#   bash commands/wanoft/train_flappy_wan_oft_mixed_latency.sh
#   bash commands/wanoft/train_flappy_wan_oft_mixed_latency.sh trainer.max_train_steps=1000
...
RUN_ID="${RUN_ID:-wan_oft_flappy_mixed_latency_context${CONTEXT_WINDOW}_${EPISODES_PER_LATENCY}ep_per_lat_standard_sft_${MAX_TRAIN_STEPS}_effbs${EFFECTIVE_BATCH_SIZE}_224_currentce}"
