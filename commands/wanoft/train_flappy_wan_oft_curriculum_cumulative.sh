...
# Usage:
#   bash commands/wanoft/train_flappy_wan_oft_curriculum_cumulative.sh
#   bash commands/wanoft/train_flappy_wan_oft_curriculum_cumulative.sh trainer.max_train_steps=1000
